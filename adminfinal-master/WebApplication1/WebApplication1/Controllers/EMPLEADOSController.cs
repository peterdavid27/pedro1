...
namespace WebApplication1.Controllers
{
    public class EMPLEADOSController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,CODIGO,USERNAME,CLAVE,NOMBRE,APELLIDO,TELEFONO,DEPARTAMENTO,CARGO,FECHA_INGRESO,SALARIO,ESTATUS")] EMPLEADOS eMPLEADOS)
        {
